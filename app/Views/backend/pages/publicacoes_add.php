...
<div class="col-md-12">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Inserir Publicação</h6>
    </div>
    <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <select name="categoria" class="form-control" tabindex="-1">
                  <option value="">Escolha Tipo de Publicação</option>
                  <?php foreach ($categorias as $categorias_item) : ?>
                    <option value="<?= $categorias_item['id'] ?>"><?= $categorias_item['titulo'] ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="input" name="indexbase" />
            </div>

            <div class="form-group">
              <label for="numautor">Número de Autores</label>
              <input class="form-control" type="number" name="numautor" />
            </div>

            <div class="form-group">
              <label for="autores">Nome dos Autores</label>
              <input class="form-control" type="input" name="autores" />
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="input" name="revistas" />
            </div>
