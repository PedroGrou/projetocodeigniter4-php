...
!(function () {
  ...
  (dt.attr = function (e, t) {
    ...
    var n = Z.attrHandle[t.toLowerCase()],
      r =
        n && Ue.call(Z.attrHandle, t.toLowerCase()) ? n(e, t, !fe) : undefined;
    return r !== undefined
      ? r
      : Q.attributes || !fe
      ? e.getAttribute(t)
  ...
  (Ct.prototype = Z.filters = Z.pseudos),
    ...
    (oe = dt.select =
      function (e, t, n, r) {
        ...
        return (
          (c || re(e, l))(r, t, !fe, n, (st.test(e) && bt(t.parentNode)) || t),
          n
        );
      }),
        ...
        var v = function (e) {
          ...
          t = function (t) {
            return Yr.nu(function (e) {
              n(
                t,
                V.compose(e, V.constant(to.value(t))),
                V.compose(e, V.constant(to.error(t)))
              );
            });
          },
          o = function (e) {
      ...
      q = {
        ...
        getOuterHTML: function (e) {
          ...
          return Ao.isElement(t)
            ? t.outerHTML
            : en("<div></div>").append(en(t).clone()).html();
        },
  ...
  var Rs,
    ...
    Vs = function (e, t) {
      if (cs(e)) {
        if (Fs(t.previousSibling) && !Ls(t.previousSibling))
          return Ba.before(t);
    ...
    Mc =
      ...
      (Ds = zn.detect().browser),
      {
        get: function (e) {
          if (!Rs(e))
            throw new Error(
              "Can only get " + Bs + " value of a " + Bs + " node"
            );
          return Os(e).getOr("");
        },
        getOption: (Os =
  ...
  var Jc = function (e, t, n) {
    ...
    Qc = function (e, t) {
      return H.find(e.dom().childNodes, V.compose(t, qn.fromDom)).map(
        qn.fromDom
      );
    },
    Zc = function (e, r) {
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              u && u.external_plugins
                ? Lt.extend({}, u.external_plugins, c)
                : c),
          }
        );
      return ul(e, v, n, y);
    ...
    qf = function (e, t) {
      return e
        ? t.fold(
            V.compose(A.some, kf.start),
            A.none,
            V.compose(A.some, kf.after),
            A.none
          )
        : t.fold(
            A.none,
            V.compose(A.some, kf.before),
            A.none,
            V.compose(A.some, kf.end)
          );
    },
    Vf = function (a, u, s, c) {
  ...
  var Um,
    ...
    jm = function (e, t) {
      return "selectionchange" === t
        ...
        ? (e.eventRoot || (e.eventRoot = Hm.select(e.settings.event_root)[0]),
          e.eventRoot)
        : e.getBody();
    },
    $m = function (i, a) {
      ...
      e._clickBlocker && (e._clickBlocker.unbind(), (e._clickBlocker = null)),
        t
          ? ((e._clickBlocker =
              ((r = (n = e).getBody()),
              (o = function (e) {
                0 < n.dom.getParents(e.target, "a").length &&
                  e.preventDefault();
              }),
      ...
      i.on("SelectionChange", function () {
        ...
        !e ||
          ...
          (!(function (e) {
            var t, n;
            if (
              (n = i.$(e).parentsUntil(i.getBody()).add(e)).length === o.length
            ) {
      ...
      r.collapsed ||
        ...
        Wh(
          ...
          function (e) {
            ...
            (t = e.previousSibling),
              en((n = e)).remove(),
              en(t).append("<br><br>").append(n.childNodes);
          }
        ));
  }),
    jh[(ih = "pre")] || (jh[ih] = []),
      ...
      (Rh.matchNode(t, i.parentNode, r, o) && ov.removeFormat(t, n, o, i)) ||
        (n.merge_with_parents &&
          t.dom.getParent(i.parentNode, function (e) {
            if (Rh.matchNode(t, e, r, o))
              return ov.removeFormat(t, n, o, i), !0;
          }));
    },
    Cv = Lt.each,
    xv = function (p, g, h, r) {
  ...
  var lC = function (e) {
    ...
    pC = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        (t.parser =
          ((o = uy((u = t).settings, u.schema)).addAttributeFilter(
